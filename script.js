...
(function () {
  ...
  var I18N = {
    en: {
      "brand.title": "BorendroDak Foundation",
      ...
      "about.who.p": "BorendroDak Health & Welfare Foundation is a community-based initiative in Rajshahi that focuses on patient coordination and welfare support. We help connect people to services—doctors, blood support, emergency medicine, and transport—through a single hotline.",
      "about.mission.h3": "Mission",
      "about.mission.p": "Reduce delays and confusion during health emergencies by coordinating help quickly and responsibly.",
      "about.values.h3": "Values",
      "about.values.p": "Transparency, dignity, speed, privacy, and community partnership.",
    ...
    bn: {
      ...
      "about.who.p": "বরেন্দ্রডাক স্বাস্থ্য ও সমাজকল্যাণ ফাউন্ডেশন রাজশাহীতে কমিউনিটি-ভিত্তিক একটি উদ্যোগ। আমরা রোগী সমন্বয় ও কল্যাণ সহায়তায় কাজ করি—ডাক্তার, রক্ত সহায়তা, জরুরি ঔষধ ও পরিবহন—সবকিছু একটিমাত্র হটলাইনে সমন্বয় করে দিই।",
      "about.mission.h3": "মিশন",
      "about.mission.p": "স্বাস্থ্য জরুরিতে দেরি ও বিভ্রান্তি কমাতে দ্রুত ও দায়িত্বশীলভাবে সহায়তা সমন্বয় করা।",
      "about.values.h3": "মূল্যবোধ",
      "about.values.p": "স্বচ্ছতা, সম্মান, দ্রুততা, গোপনীয়তা এবং কমিউনিটি অংশীদারিত্ব।",
